// src/letters/uppercase/V/index.ts
...
export const build: LetterBuild = (box: BoundingBox) => {
  // Scale both V strokes to the bounding box
...
export const theme: LetterTheme = {
  ...
  colors: {
    pathGradientStart: '#7C3AED',  // Violet for V
    pathGradientEnd: '#C4B5FD',    // Light Violet
    guideDot: '#EDE9FE',           // Very Light Violet
  },
  bee: {
    speedMsPerPoint: 5,
    pauseAtEndMs: 400,
